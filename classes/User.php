...
class User
   ...
   public function setIsLibrarian($inID)
       {
            ...
            $result = mysqli_query($dbc, $query) or die('gah!- query issues.'.mysql_error().$query);
   ...
   public function setLibrarianName($inID)
         ...
         $result = mysqli_query($dbc, $query) or die('crustacean!- query issues.'.$query.'<br>'.mysql_error());
          if(!$result){echo "this is an outrage: ".mysql_error()."\n";}
             ...
             $result = mysqli_query($dbc, $query) or die('This is an outrage-in function getMySessions query issues.'.$query);
                ...
                while ( $row = mysqli_fetch_assoc( $result) )
                {
                    ...
                    $output.="<tr class='mySessions'>".
                            ...
                            "<td>$outcomeDone</td>".
                            "<td>$AssessedDone</td>".
                            "<td><form method='post' action='deleteSession.php'>".
     ...
     public function getNeedAssessed($inID)
         ...
         $query = "select  c.crspName as Name, count(s.sesdcrspID) as Count ".
                ...
                if(!$result){echo "this is an outrage -in getNeedAssessment-: ".mysql_error()."\n".$query;}
